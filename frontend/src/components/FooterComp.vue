<template>
  <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    <div class="mx-6 py-10 text-center md:text-left">
      ...
      <div class="flex lg:flex-row flex-col justify-evenly">
        <div class="flex flex-col justify-center items-center lg:mb-0 mb-4 lg:w-1/2">
          ...
          <p class="mb-4">
            <a href="#!" class="text-gray-600">Support us</a>
          </p>
          <p class="mb-4">
        ...
        <div class="flex flex-col justify-center items-center w-full">
          ...
          <a class="text-gray-600 font-semibold">
            FindPet © 2022 | All Rights Reserved</a
          >
        </div>
        <div class="flex flex-col justify-center gap-4">
          <h1 class="text-gray-600 font-semibold">Newsletter</h1>
          <p>
    ...
    <div class="text-center p-6 bg-gray-200">
      ...
      <a class="text-gray-600 font-semibold"> DEVELOPED BY Hala Ziani</a>
    </div>
  </footer>
</template>
